      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        duration: 0.5
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <img src="/lovable-uploads/ff4494f6-4e60-40c7-afc6-416b0efeef5f.png" alt="Pink programmer bird mascot with glasses" className="w-full h-full object-contain p-4" />
            </div>
          </div>
        </motion.div>
        ...
        duration: 0.5
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            {user ? <Button size="lg" variant="outline" onClick={() => handleNavigation('/dashboard')} disabled={isLoading} className="border-white hover:bg-white/20 text-lg px-8 py-6 text-violet-600">
